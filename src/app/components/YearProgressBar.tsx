  ...
  return (
    <motion.div
      className={`fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200
                 flex items-center justify-center h-16 md:h-20 py-3 md:py-5 z-[40]
    ...
    >
      <div className="w-full px-4 md:px-8 relative">
        ...
        <div className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 flex items-center space-x-2 md:space-x-4">
        ...
        <div
          className="relative mx-16 md:mx-32"
        ...
        >
          ...
          {/* Main Progress Bar */}
          <div className="h-2 md:h-4 bg-gray-100 rounded-full overflow-hidden relative">
            ...
            {/* Progress fill */}
            <div
              className="h-full bg-gray-900 relative z-[1]"
              style={{ width: `${progress}%` }}
            />

            {/* Quarter dividers */}
            <div className="absolute inset-0 flex justify-between pointer-events-none z-[2]">
              <div className="h-full w-[2px] md:w-[3px] bg-gray-400" />
              <div
                className={`h-full w-[2px] md:w-[3px] ${
